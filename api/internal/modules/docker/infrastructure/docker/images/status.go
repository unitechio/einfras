...
import (
	...
	consts "einfra/api/docker/consts"
...
func (c *DigestClient) ContainersImageStatus(ctx context.Context, containers []types.Container, endpoint *einfra.Endpoint) Status {
...
func (c *DigestClient) ContainerImageStatus(ctx context.Context, containerID string, endpoint *einfra.Endpoint, nodeName string) (Status, error) {
...
func (c *DigestClient) ServiceImageStatus(ctx context.Context, serviceID string, endpoint *einfra.Endpoint) (Status, error) {
	cli, err := c.clientFactory.CreateClient(endpoint, "", nil)
	if err != nil {
		return Error, nil
	}
