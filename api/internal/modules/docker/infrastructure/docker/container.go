...
func (c *ContainerService) Recreate(ctx context.Context, endpoint *einfra.Endpoint, containerId string, forcePullImage bool, imageTag, nodeName string) (*types.ContainerJSON, error) {
	...
	// see: https://einfra.atlassian.net/browse/EE-5448
