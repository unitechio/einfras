...
type Heartbeat struct {
	...
	MemoryGb      float32                `protobuf:"fixed32,6,opt,name=memory_gb,json=memoryGb,proto3" json:"memory_gb,omitempty"`
	DiskGb        int32                  `protobuf:"varint,7,opt,name=disk_gb,json=diskGb,proto3" json:"disk_gb,omitempty"`
	HasDocker     bool                   `protobuf:"varint,8,opt,name=has_docker,json=hasDocker,proto3" json:"has_docker,omitempty"`
	HasK8S        bool                   `protobuf:"varint,9,opt,name=has_k8s,json=hasK8s,proto3" json:"has_k8s,omitempty"`
...
func (x *Heartbeat) GetMemoryGb() float32 {
	if x != nil {
		return x.MemoryGb
	}
	return 0
...
func (x *Heartbeat) GetDiskGb() int32 {
	if x != nil {
		return x.DiskGb
	}
	return 0
...
func (x *Heartbeat) GetHasDocker() bool {
	if x != nil {
		return x.HasDocker
	}
	return false
...
func (x *Heartbeat) GetHasK8S() bool {
	if x != nil {
		return x.HasK8S
	}
	return false
...
func (x *Heartbeat) GetArch() string {
	if x != nil {
		return x.Arch
	}
	return ""
...
const file_agent_proto_rawDesc = "" +
	"\n" +
	"\vagent.proto\x12\bagent.v1\"\xa7\x03\n" +
	...
	"\fcapabilities\x18\x04 \x03(\tR\fcapabilities\"\xeb\x02\n" +
	"\tHeartbeat\x12\x1f\n" +
	...
	"\fdisk_percent\x18\x04 \x01(\x02R\vdiskPercent\x12\x1b\n" +
	"\tcpu_cores\x18\x05 \x01(\x05R\bcpuCores\x12\x1b\n" +
	"\tmemory_gb\x18\x06 \x01(\x02R\bmemoryGb\x12\x17\n" +
	"\adisk_gb\x18\a \x01(\x05R\x06diskGb\x12\x1d\n" +
	"\n" +
	"has_docker\x18\b \x01(\bR\thasDocker\x12\x17\n" +
	"\ahas_k8s\x18\t \x01(\bR\x06hasK8s\x12\x0e\n" +
	"\x02os\x18\n" +
	" \x01(\tR\x02os\x12\x12\n" +
	"\x04arch\x18\v \x01(\tR\x04arch\x12#\n" +
	"\ragent_version\x18\f \x01(\tR\fagentVersion\"h\n" +
	"\n" +
	"TaskOutput\x12\x17\n" +
