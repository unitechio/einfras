...
import { ServiceLog, mockServerService } from "../shared/mockServerService";
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/50 backdrop-blur-sm transition-opacity duration-300">
      ...
      >
        ...
        <div className="flex flex-col border-b border-zinc-200 dark:border-zinc-800">
          <div className="flex items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={handleCopy}
                className="p-2 text-zinc-500 hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-200 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-lg transition-colors border border-transparent hover:border-zinc-200 dark:hover:border-zinc-700"
                title="Copy logs"
              >
                <Copy size={18} />
              </button>
              ...
              <button
                onClick={onClose}
                className="p-2 ml-2 text-zinc-400 hover:text-red-500 transition-colors rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20"
              >
                <X size={20} />
              </button>
            </div>
        ...
        <div
          ref={scrollRef}
          className="flex-1 overflow-y-auto p-4 bg-zinc-950 font-mono text-sm leading-relaxed"
        >
