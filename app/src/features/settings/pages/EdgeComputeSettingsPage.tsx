      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-zinc-200 dark:border-zinc-800 pb-5">
        <div>
          ...
          <p className="text-[13px] text-zinc-500 dark:text-zinc-400 mt-1.5">
            Configure edge agents, distributed runtime features, and
          ...
          <div className="bg-white dark:bg-[#121212] border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-1.5">
                  ...
                  <p className="text-[12px] text-zinc-500 mt-1">
                    How often edge nodes fetch new tasks.
                  </p>
                </div>
                <div className="space-y-1.5">
                  <label className="text-[13px] font-medium text-zinc-700 dark:text-zinc-300">
              ...
              <div className="space-y-1.5">
                ...
                />
                <p className="text-[12px] text-zinc-500 mt-1">
                  Time to live for local edge caching of API responses.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 rounded-xl p-5">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-[14px] font-semibold text-indigo-900 dark:text-indigo-300">
                Edge Network
              </h3>
            </div>
            <p className="text-[13px] text-indigo-800/80 dark:text-indigo-300/80 leading-relaxed mb-4">
              Your environment is currently configured to support edge compute
              extensions. Note that some settings may require restarting the
              agent to take full effect.
            </p>
            <Button
              variant="outline"
              className="w-full bg-white dark:bg-zinc-900 border-indigo-200 dark:border-indigo-500/30 text-indigo-700 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-500/20 text-[13px]"
            >
          ...
          <div className="bg-white dark:bg-[#121212] border border-zinc-200 dark:border-zinc-800 rounded-xl p-5 shadow-sm">
            <h4 className="text-[13px] font-semibold text-zinc-900 dark:text-white uppercase tracking-wider mb-4">
              Quick Stats
            </h4>
            <div className="space-y-4">
              <div>
                <div className="flex justify-between items-center text-[12px] mb-1.5">
                  <span className="text-zinc-500 dark:text-zinc-400 flex items-center gap-1.5">
                    <Server className="w-3.5 h-3.5" /> Active Edge Nodes
                  </span>
              ...
              <div>
                <div className="flex justify-between items-center text-[12px] mb-1.5">
                  <span className="text-zinc-500 dark:text-zinc-400 flex items-center gap-1.5">
                    <Activity className="w-3.5 h-3.5" /> Network Health
                  </span>
                  <span className="font-semibold text-zinc-900 dark:text-white">
                    Good
                  </span>
