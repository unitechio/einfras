...
const availablePermissions: Permission[] = [
  {
    ...
    category: "Server",
    name: "Read",
    description: "View server inventory and details",
  },
  {
    id: "server:write",
    category: "Server",
  ...
  },
  {
    ...
    category: "Server",
    name: "Execute",
    description: "SSH and terminal actions",
  },
  {
    id: "firewall:read",
    category: "Firewall",
  ...
  },
  {
    ...
    category: "Firewall",
    name: "Write",
    description: "Create and update firewall rules",
  },
  {
    id: "firewall:delete",
    category: "Firewall",
  ...
  },
  {
    ...
    category: "SSH",
    name: "Read",
    description: "View SSH keys and access records",
  },
  {
    id: "ssh_key:write",
    category: "SSH",
  ...
  },
  {
    ...
    category: "SSH",
    name: "Execute",
    description: "Use SSH access to a resource",
  },
  {
    id: "audit_log:read",
    category: "Audit",
...
export default function RolesPage() {
  ...
  function toggleAllInCategory(category: string) {
    const categoryIDs = permissionsByCategory[category].map(
      (permission) => permission.id,
    );
    const allSelected = categoryIDs.every((permissionID) =>
    ...
    setForm((current) => ({
      ...
      permissions: allSelected
        ? current.permissions.filter(
            (permissionID) => !categoryIDs.includes(permissionID),
          )
  ...
  async function handleSubmit() {
    ...
    try {
      if (isCreating) {
        ...
        const updated = await usersTeamsApi.updateRole(
          selectedRole.id,
          payload,
        );
        setRoles((current) =>
  ...
  return (
    <>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
              Define reusable permission bundles without hardcoding access in
              product logic.
            </p>
          </div>
                  ...
                  <TableRow>
                    ...
                    <TableHead className="text-right">
                      <button
                        ...
                        className="ml-auto inline-flex items-center gap-1 text-left"
                      >
                        Type
          ...
          <section className="overflow-hidden rounded-md border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-[#121212]">
            <div className="border-b border-zinc-200 bg-zinc-50/70 px-6 py-4 dark:border-zinc-800 dark:bg-zinc-900/30">
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400">
                Bundle resource permissions for admin, devops and custom tenant
                personas.
              </p>
            </div>
            ...
            <div className="space-y-5 p-6">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  disabled={selectedRole?.is_system}
                  className="w-full rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-900 outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 disabled:opacity-60 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-100"
              ...
              <div className="rounded-md border border-zinc-200 p-4 dark:border-zinc-800">
                <div className="mb-3">
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">
                    Resource + action grants used by the backend permission
                    engine.
                  </p>
                </div>
              ...
              {selectedRole?.is_system ? (
                <div className="flex items-start gap-3 rounded-md border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-700 dark:border-blue-900/40 dark:bg-blue-950/30 dark:text-blue-300">
                  <Info className="mt-0.5 h-4 w-4 shrink-0" />
                  System roles are seeded by the platform and remain read-only
                  in the UI. You can inspect permissions here, but editing is
      ...
      <ConfirmActionDialog
        ...
        description={
          deleteCandidate
            ? `This permanently removes role ${deleteCandidate.name} and its permission bundle.`
            : ""
        }
