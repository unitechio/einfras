...
export default function TeamsPage() {
  ...
  const [deleteCandidate, setDeleteCandidate] = useState<TeamRecord | null>(
    null,
  );
  ...
  async function handleSubmit() {
    ...
    try {
      if (isCreating) {
        ...
        const updated = await usersTeamsApi.updateTeam(
          selectedTeam.id,
          payload,
        );
        setTeams((current) =>
  ...
  return (
    <>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
              Organize people into access groups that power ownership and ABAC
              checks.
            </p>
          </div>
          ...
          <section className="overflow-hidden rounded-md border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-[#121212]">
            <div className="border-b border-zinc-200 bg-zinc-50/70 px-6 py-4 dark:border-zinc-800 dark:bg-zinc-900/30">
              <div className="flex items-center gap-3">
                <div className="flex h-11 w-11 items-center justify-center rounded-md bg-cyan-50 text-cyan-700 dark:bg-cyan-500/10 dark:text-cyan-300">
            ...
            <div className="space-y-5 p-6">
              ...
              <div className="rounded-md border border-zinc-200 p-4 dark:border-zinc-800">
                ...
                <div className="grid max-h-96 gap-2 overflow-y-auto pr-1 md:grid-cols-2">
                  ...
                  {users.length === 0 ? (
                    <div className="rounded-md border border-dashed border-zinc-300 px-3 py-4 text-sm text-zinc-500 dark:border-zinc-700 dark:text-zinc-400">
      ...
      <ConfirmActionDialog
        ...
        description={
          deleteCandidate
            ? `This removes team ${deleteCandidate.name} and its member mapping.`
            : ""
        }
