            ...
            <div className="grid gap-3 sm:grid-cols-2 xl:min-w-[460px]">
              <label className="space-y-1.5">
                ...
                <select
                  ...
                  className="h-11 w-full rounded-md border border-zinc-200 bg-white px-3 text-sm font-medium text-zinc-900 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-100"
                >
